...
data class TransparencyCheckResult(
    ...
    /**
     * SHA-256 fingerprints of the APK signing certificates associated with the package. Starting from
     * API level 28, this includes both the signing certificate associated with the signer of the
     * package and the past signing certificates it included as its proof of signing certificate
     * rotation.
     *
    ...
    /**
     * Error message containing information about the cause of code transparency verification failure.
